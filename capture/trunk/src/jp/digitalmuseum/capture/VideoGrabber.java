...
/**
 * Grab image objects and delivery them to listeners.
 *
 * @author Jun Kato
 * @see VideoListener
 */
public class VideoGrabber extends VideoGrabberAbstractImpl {

	private List<VideoListener> listeners;

	public VideoGrabber() { super(); }
	public VideoGrabber(VideoCapture capture) { super(capture); }
	...
	/** Remove a VideoListener. */
	public void removeVideoListener(VideoListener listener) {
		listeners.remove(listener);
	}

	final public void actionPerformed(ActionEvent e) {
		final BufferedImage image = getCapturer().grabFrame();
