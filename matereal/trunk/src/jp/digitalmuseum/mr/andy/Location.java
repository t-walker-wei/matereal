...
public class Location {
	...
	public Location(Location l) {
		location = new jp.digitalmuseum.utils.Location(l.location);
		screenLocation = new jp.digitalmuseum.utils.ScreenLocation(l.screenLocation);
	}
	...
	synchronized void setLocation(jp.digitalmuseum.utils.Location l) {
