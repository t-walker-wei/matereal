...
public class StartCleaning extends TaskAbstractImpl {
	private static final long serialVersionUID = -2386911873495825245L;

	@Override
	public List<Class<? extends Resource>> getRequirements() {
		List<Class<? extends Resource>> resourceTypes = super.getRequirements();
		resourceTypes.add(CleanerBrushController.class);
		return resourceTypes;
	}

	@Override
	protected void onStart() {
		getResourceMap().get(CleanerBrushController.class).startCleaning();
	}
