...
This library includes whole distribution of Webcam capture
package, or simply "capture" for capturing images with webcams.
"capture" is developed by the same author and distributed under
the same license with this library.
