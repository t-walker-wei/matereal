...
public class Andy {
	...
	public CoordProvider getCoordProvider() {
		if (coordProvider == null) {
			coordProvider = Matereal.getInstance()
					.lookForServices(CoordProvider.class)
					.iterator().next();
			if (coordProvider == null) {
				//
			}
	...
	public LocationProvider getLocationProvider() {
		if (locationProvider == null) {
			locationProvider = Matereal.getInstance()
					.lookForServices(LocationProvider.class)
					.iterator().next();
			if (locationProvider == null) {
				//
			}
	...
	public BufferedImage getImage() {
		return getCoordProvider().getImage();
	}

	public void drawImage(Graphics g) {
		getCoordProvider().drawImage(g);
	}
